        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gears_AspNetUsers_ApplicationuserId",
                        column: x => x.ApplicationuserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GearTrips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GearTrips_Gears_GearId",
                        column: x => x.GearId,
                        principalTable: "Gears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GearTrips_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedRequest = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedGears", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedGears_AspNetUsers_ApplicationuserId",
                        column: x => x.ApplicationuserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedGears_Gears_GearId",
                        column: x => x.GearId,
                        principalTable: "Gears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gears_ApplicationuserId",
                table: "Gears",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GearTrips_GearId",
                table: "GearTrips",
                column: "GearId");

            migrationBuilder.CreateIndex(
                name: "IX_GearTrips_TripId",
                table: "GearTrips",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedGears_ApplicationuserId",
                table: "SharedGears",
                column: "ApplicationuserId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedGears_GearId",
                table: "SharedGears",
                column: "GearId");
